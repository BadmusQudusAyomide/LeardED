...
<body>
			...
			<div class="quote">
				...
				<div class="play">
					<img src="images/icon/play.png" alt="play"><span><a
							href="https://www.youtube.com/watch?v=KFyrgDO1WXk" target="_blank">Watch Now</a></span>
				</div>
			</div>
			<div class="svg-image">
	...
	<div class="title">
		<span>Popular Courses on LearnEd</span>
	</div>
	<br><br>
	<div class="course">
		<center>
			<div class="cbox">
				<div class="det"><a href="subjects/jee.html"><img src="images/courses/book.png">Harmattan Semester</a>
				</div>
				<div class="det"><a href="subjects/gate.html"><img src="images/courses/d1.png">Rain Semester</a>
				</div>
				<div class="det"><a href="subjects/jee.html#sample_papers"><img src="images/courses/paper.png">Lecture
						Materials</a></div>
		...
		<div class="cbox">
			<div class="det"><a href="subjects/computer_courses.html"><img src="images/courses/computer.png">Computer
					Courses</a></div>
			<div class="det"><a href="subjects/computer_courses.html#data"><img src="images/courses/data.png">Past
					Questions</a></div>
	...
	<div class="diffSection" id="team_section">
		...
		<div class="totalcard">
			<div class="card">
				<center><img src="images/creator/badmus.jpg"></center>
				<center>
					<div class="card-title">Badmus Qudus Ayomide</div>
					<div id="detail">
			...
			<div class="card">
				<center><img src="images/creator/11.jpg"></center>
				<center>
					<div class="card-title">Samuel Oluwabiyi</div>
					<div id="detail">
	...
	<div class="service-swipe">
		...
		<a href="subjects/jee.html#sample_papers">
			<div class="s-card"><img src="images/icon/papers.jpg">
				<p>Lecture Materials for Various Course</p>
			</div>
		</a>
		<a href="#">
